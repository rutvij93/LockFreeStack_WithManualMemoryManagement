...
public class EliminationStackCorrectness {
	...
	static LockFreeStack<Integer> instance1 = new LockFreeStack<Integer>();
...
//		}
	    ...
	    System.out.println("Push: " + EliminationBackoffStack.push + ", Successful Pop: " + EliminationBackoffStack.pop +
	    		", Successful Eliminations: " + EliminationBackoffStack.count);
	    if (EliminationBackoffStack.count == 0){
	    	System.out.println("Keep Delay 0 to see sizeble number of eliminations. Also increase the contention");
	    }
	    int remaining = 0;
	    while(true){
	    	try {
	    ...
	    System.out.println("Total number of nodes recycled: " + LockFreeStackRecycle2.count);
	}
